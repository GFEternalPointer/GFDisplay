...
typedef enum : NSUInteger {
    GFTitleColorGradientStyleRGB , // RGB:默认RGB样式
    GFTitleColorGradientStyleFill, // 填充
} GFTitleColorGradientStyle;

@interface GFDisplayViewController : UIViewController
